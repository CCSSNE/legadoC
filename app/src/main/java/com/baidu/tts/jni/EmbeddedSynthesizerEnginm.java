...
public class EmbeddedSynthesizerEnginm implements IEmbeddedSynthesizerEngine {
    ...
    static {
        ...
        System.loadLibrary("bd_ettm");
        bdTTSSetNativeLogLevel(3);
    }

    public EmbeddedSynthesizerEnginm(String str) {
        this.tag = "EmbeddedSynthesizerEnginm_" + str;
    }
