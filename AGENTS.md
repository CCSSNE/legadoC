...
- `3.26.081532c` / `10611`，2026-08-15，已在雷电模拟器安装。书签无头、局部模糊且窗口无 `DIM_BEHIND`；帮助/日志的 Toolbar 动作迁至底部；标准“图片样式”选择框标题作为正文首行，与首项不重叠；内容编辑的 RecyclerView 与保存/重置/拷贝所有 footer 仅相邻、不重叠。
