...
- 最近一次自用版交付为 `3.26.090219` / `10811`，2026-09-02 UTC 19 时，使用 `assembleAppC` 冷编译成功。产物包名 `io.legado.app.dev`、versionName `3.26.090219c`、versionCode `10811`、架构 `arm64-v8a`，`aapt` 确认应用名 `阅读C-自用`（label-zh 逐字匹配）、`apksigner` 验证通过；APK 位于 `app\build\outputs\apk\app\c\legado_app_3.26.090219_10811.apk`。本次未安装模拟器、未做正式回归。上一自用版为 `3.26.090217` / `10810`；最近公开版仍为 `3.26.090209` / `10804`。
