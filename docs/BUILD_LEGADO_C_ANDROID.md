...
7. 已交付的 `3.26.062205c` 是 `10491`；当前最新测试包是 `3.26.081107c` / `10507`，后续覆盖包必须从 `10508` 起步。
...
```text
D:\AI\audio\legadoC-own\app\build\outputs\apk\app\c\legado_app_3.26.081107_10507.apk
```

检查包名、版本、ABI：

```powershell
$apk='D:\AI\audio\legadoC-own\app\build\outputs\apk\app\c\legado_app_3.26.081107_10507.apk'
